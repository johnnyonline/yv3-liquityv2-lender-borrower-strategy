...
contract RETHToBOLDExchange is IExchange {
    ...
    /// @notice WETH/rETH Curve Pool
    int128 private constant WETH_INDEX_WETH_RETH_CURVE_POOL = 0;
    int128 private constant RETH_INDEX_WETH_RETH_CURVE_POOL = 1;
    ICurvePool private constant WETH_RETH_CURVE_POOL = ICurvePool(0x9EfE1A1Cbd6Ca51Ee8319AFc4573d253C3B732af);
    ...
    constructor() {
        ...
        WETH.forceApprove(address(WETH_RETH_CURVE_POOL), type(uint256).max);
        RETH.forceApprove(address(WETH_RETH_CURVE_POOL), type(uint256).max);
    }
    ...
    function _swapFrom(
        ...
        // WETH --> rETH
        _amountOut = WETH_RETH_CURVE_POOL.exchange(
            WETH_INDEX_WETH_RETH_CURVE_POOL,
            RETH_INDEX_WETH_RETH_CURVE_POOL,
            _amountOut,
            0, // minAmount
            msg.sender // receiver
        );
    ...
    function _swapTo(
        ...
        // Pull rETH
        RETH.safeTransferFrom(msg.sender, address(this), _amount);

        // rETH --> WETH
        uint256 _amountOut = WETH_RETH_CURVE_POOL.exchange(
            RETH_INDEX_WETH_RETH_CURVE_POOL,
            WETH_INDEX_WETH_RETH_CURVE_POOL,
            _amount,
            0, // minAmount
